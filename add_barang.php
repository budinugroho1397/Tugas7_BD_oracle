            ...
            <form method="POST" action="input_barang.php" >
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" name="NAMA_BARANG" class="form-control" id="#" placeholder="merk kendaraan">
                </div>
                <div class="form-group">
                  <label for="harga">Unit</label>
                  <input type="text" name="UNIT" class="form-control" id="#" placeholder="merk kendaraan">
                </div>
                <div class="form-group">
                  <label for="harga">QTY</label>
                  <input type="number" name="QTY" class="form-control" id="#" placeholder="Stok">
                </div>
                <div class="form-group">
